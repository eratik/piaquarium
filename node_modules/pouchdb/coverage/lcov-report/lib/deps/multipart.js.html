...
<html lang="en">
<head>
    <title>Code coverage report for lib/deps/multipart.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/deps/multipart.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">97.5% <small>(39 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/deps/</a> &#187; multipart.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">67</span>
<span class="cline-any cline-yes">747</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
function createBlobOrBuffer(parts, type) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isBrowser) {
<span class="cstat-no" title="statement not covered" >    return createBlob(parts, {type: type});</span>
  }
...
&nbsp;
  Object.keys(nonStubAttachments).forEach(function (filename) {
    ...
    var preamble = '\r\n--' + boundary +
      ...
      '\r\n\r\n';
    parts.push(preamble);
    parts.push(isBrowser ? <span class="branch-0 cbranch-no" title="branch not covered" >binaryStringToArrayBuffer(att.data) </span>: att.data);
  });
&nbsp;
  parts.push('\r\n--' + boundary + '--');
&nbsp;
