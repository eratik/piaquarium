...
<html lang="en" manifest="/manifest.appcache">
  ...
  <head>
    ...
    <title>PouchDB 5.1.0 - Cover all the things</title>
    ...
    <header role="banner">
      ...
      <div class="page-head">
        ...
        <div class="container">
          ...
          <h1 class="page-title">PouchDB 5.1.0 - Cover all the things</h1>
...
<a
  ...
  class="icon-edit"
  href="https://github.com/pouchdb/pouchdb/edit/master/docs/_posts/2015-11-03-cover-all.md"
  target="_blank"
></a>
...
<div class="post">
  <div class="media">
    ...
    <p>
      ...
      <strong>Published:</strong> 03 November 2015<br>
      ...
      <p>It is time for the regularly scheduled PouchDB release, this month has a nice set of improvements, and we even managed to remove a little (<code>3KB</code>) around the edges.</p>

<h3>Coverage</h3>

<p>We are now very happy to be hitting <a href="https://coveralls.io/github/pouchdb/pouchdb/">100% coverage on our tests</a>. This currently only covers Node.js and excludes some cases that are difficult to test but it does give us confidence that our shared code is very well tested and we can ensure new code that is merged has the same level of testing.</p>

<h3>GreenKeeper</h3>

<p>We have had issues in the past with how to manage npm dependencies. Version ranges can lead to other people breaking PouchDB with their releases, and strict versions lead to us using stagnant packages and not being aware of upcoming breakages. During this month, the <a href="http://hood.ie">hood.ie team</a> released <a href="http://greenkeeper.io">GreenKeeper</a> which gives us best of both worlds, stable versions that are always kept up to date!</p>

<h3>New features</h3>

<ul>
<li>Add an option to configure <code>withCredentials</code> on CORS requests (<a href="http://github.com/pouchdb/pouchdb/issues/2513">#2513</a>)</li>
<li>Allow user to disable <code>heartbeat</code> in HTTP requests (<a href="http://github.com/pouchdb/pouchdb/issues/4490">#4490</a>)</li>
</ul>

<h3>Bugfixes</h3>

<ul>
<li>Explain http error caused by checking for <code>_bulk_get</code> (<a href="http://github.com/pouchdb/pouchdb/issues/4435">#4435</a>)</li>
<li>Dont create a database just to delete it (<a href="http://github.com/pouchdb/pouchdb/issues/4467">#4467</a>)</li>
<li>Add friendly err msg to common leveldown err (<a href="http://github.com/pouchdb/pouchdb/issues/4447">#4447</a>)</li>
<li>Avoid empty bulkGet() (<a href="http://github.com/pouchdb/pouchdb/issues/4474">#4474</a>)</li>
<li>Fix http url with port 80 (<a href="https://github.com/pouchdb/express-pouchdb/issues/247">#247</a>)</li>
<li>Url encode http database name (<a href="http://github.com/pouchdb/pouchdb/issues/4314">#4314</a>)</li>
<li>Handle invalid view name consistently (<a href="http://github.com/pouchdb/pouchdb/issues/4451">#4451</a>)</li>
<li>Remove put implementation and fix local doc handling (<a href="http://github.com/pouchdb/pouchdb/issues/1526">#1526</a>)</li>
<li>Fix cross origin check (<a href="http://github.com/pouchdb/pouchdb/issues/4501">#4501</a>)</li>
</ul>
