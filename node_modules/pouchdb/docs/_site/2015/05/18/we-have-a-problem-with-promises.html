...
<div class="post">
  <div class="media">
    ...
    <p>
      ...
      <strong>Published:</strong> 18 May 2015<br>
...
<p>Notice that I&#39;m <code>return</code>ing the second promise &ndash; that <code>return</code> is crucial. If I didn&#39;t say <code>return</code>, then the <code>getUserAccountById()</code> would actually be a <em>side effect</em>, and the next function would receive <code>undefined</code> instead of the <code>userAccount</code>.</p>
...
<p>You might na&iuml;vely write something like this:</p>
...
<p>I know what you&#39;re thinking: &quot;Who the hell is this Java programmer, and why is he talking about factories?&quot; A promise factory is very simple, though &ndash; it&#39;s just a function that returns a promise:</p>
...
<p>Why does this work? It works because a promise factory doesn&#39;t create the promise until it&#39;s asked to. It works the same way as a <code>then</code> function &ndash; in fact, it&#39;s the same thing!</p>
...
<p>Incidentally, the one who wrote that nasty callback code was&hellip; me! So this served as my first lesson in the raw power of promises, and I thank the other PouchDB contributors for coaching me along the way.</p>
