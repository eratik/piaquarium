...
<a
  ...
  class="icon-edit"
  href="https://github.com/pouchdb/pouchdb/edit/master/docs/_guides/replication.md"
  target="_blank"
></a>
...
<div id='couchdb-sync'></div>

<p><a class='h2 anchor' href='#couchdb-sync' name='couchdb-sync'>
CouchDB sync
</a></p>
...
<a href="/static/img/offline_replication.gif" target="_blank">
  <img class="img-responsive"  src="/static/img/offline_replication.gif" alt="Offline replication with CouchDB." />
</a>
...
<div id='setting-up-sync'></div>

<p><a class='h2 anchor' href='#setting-up-sync' name='setting-up-sync'>
Setting up sync
</a></p>
...
<div id='live–replication'></div>

<p><a class='h2 anchor' href='#live–replication' name='live–replication'>
Live replication
</a></p>
...
<div id='canceling—replication'></div>

<p><a class='h2 anchor' href='#canceling—replication' name='canceling—replication'>
...
<div id='delete-during-replication'></div>

<p><a class='h2 anchor' href='#delete-during-replication' name='delete-during-replication'>
Deleting replicated databases
</a></p>

<hr>

<p>One thing to note about replication is that it tracks the data within a database, not the database itself. If you <a href="/api.html#delete_database"><code>destroy()</code></a> a database that is being replicated to, the next time the replication starts it will transfer all of the data again, recreating the database to the state it was before it was <code>destroyed</code>. If you want the data within the database to be deleted you will need to delete via <a href="/api.html#delete_document"><code>remove()</code></a> or <a href="/api.html#batch_create"><code>bulkDocs()</code></a>. The <a href="https://github.com/marten-de-vries/pouchdb-erase">pouchdb-erase</a> plugin can help you remove the entire contents of a database.</p>

<div id='fancy-replication'></div>

<p><a class='h2 anchor' href='#fancy-replication' name='fancy-replication'>
Fancy replication
</a></p>
