    ...
    <header role="banner">
      ...
      <div class="page-head">
        ...
        <div class="container">
          ...
          <h1 class="page-title">Map/reduce queries</h1>
...
<a
  ...
  class="icon-edit"
  href="https://github.com/pouchdb/pouchdb/edit/master/docs/_guides/queries.md"
  target="_blank"
></a>
...
<div id='mappin-and-reducin'></div>

<p><a class='h2 anchor' href='#mappin-and-reducin' name='mappin-and-reducin'>
Mappin&#39; and reducin&#39;
</a></p>
...
<div id='more-about-map-reduce'></div>

<p><a class='h2 anchor' href='#more-about-map-reduce' name='more-about-map-reduce'>
...
<div id='pouchdb-find'></div>

<p><a class='h2 anchor' href='#pouchdb-find' name='pouchdb-find'>
PouchDB Find
</a></p>
...
<p>pouchdb-find is in beta, but you may find it is already sufficient for simple queries. Eventually it will replace map/reduce as PouchDB’s “flagship” query engine.</p>
